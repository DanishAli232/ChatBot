    ...
    <div style={{ display: "flex", width: "100%", justifyContent: "center" }}>
      <form style={{ position: "absolute", bottom: "16px", width: "77%" }}>
        ...
        <div className="relative">
          ...
          <button
            type="submit"
            className="absolute bottom-2 right-2.5 rounded-lg bg-blue-700 p-2 text-sm font-medium text-slate-200 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:text-base"
          >
            <svg
