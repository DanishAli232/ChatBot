...
const Conversation = ({ chats }) => {
  return (
    <div style={{ height: "542px", overflow: "auto", marginTop: "62px" }}>
      <Scrollbars
        style={{ height: "100%" }}
      ...
      >
        <div className="flex-1 space-y-6 overflow-y-auto  bg-slate-200 p-4 text-sm leading-6 text-slate-900 shadow-sm dark:bg-slate-900 dark:text-slate-300 sm:text-base sm:leading-7 pr-[24px]">
          {chats?.length > 0 ? (
            chats?.map((chat, i) => (
              <div
                key={i}
